...
const SAMPLE_PROJECTS = [
	{
		...
		details: {
			...
			endDate: '',
			deliveryOwnedBy: 'Data Engineering',
			projectManager: 'Thamarai Kannan Rajendran',
			primaryLocation: 'India-Bangalore',
			pmDelegate: 'Megha H Mathew',
			competencyHead: 'Dela Cruz, Juan',
			deliveryManager: 'Peter Parker',
			subCompetency: '',
			area: 'APAC',
			chargeCode: '69341378',
			clientCountry: 'Australia',
			methodology: 'Generic Agile Method',
			secondaryLocation: 'India (IN)',
			accountName: 'CO*****ED',
			lifeCycle: 'Limited Scope Projects',
			workDescription: '',
		},
	},
	{
		...
		details: {
			...
			endDate: '30/06/2026',
			deliveryOwnedBy: 'SAP',
			projectManager: 'Santos, Aristotle',
			primaryLocation: 'Philippines-Manila',
			pmDelegate: '',
			competencyHead: 'Garcia, Roberto',
			deliveryManager: 'Cruz, Jose',
			subCompetency: 'ABAP Development',
			area: 'APAC',
			chargeCode: '72104520',
			clientCountry: 'Philippines',
			methodology: 'SAP ASAP',
			secondaryLocation: 'India (IN)',
			accountName: '',
			lifeCycle: 'Limited Scope Project',
			workDescription: '',
		},
	},
	{
		...
		details: {
			...
			endDate: '31/12/2026',
			deliveryOwnedBy: 'Cybersecurity',
			projectManager: 'Lorilla, Miguel',
			primaryLocation: 'Singapore',
			pmDelegate: '',
			competencyHead: 'Reyes, Antonio',
			deliveryManager: 'Tan, Wei',
			subCompetency: 'SOAR',
			area: 'APAC',
			chargeCode: '83201947',
			...
			methodology: 'Generic Agile Method',
			secondaryLocation: '',
			accountName: 'Changi Airport Group',
			lifeCycle: 'Full Implementation',
			workDescription: '',
		},
	},
	{
		...
		meta: [
			['SSL', 'TC'],
			['Competency', 'ServiceNow'],
			['Project Manager', 'Florendo, Michael'],
			['Life Cycle', 'Custom Implementation'],
		],
		kpis: [
			['Integrated Review Score', '—'],
		...
		details: {
			...
			endDate: '30/09/2026',
			deliveryOwnedBy: 'ServiceNow',
			projectManager: 'Florendo, Michael',
			primaryLocation: 'Philippines-Manila',
			pmDelegate: 'Santos, Liza',
			competencyHead: 'Flores, Carlo',
			deliveryManager: 'Lim, David',
			subCompetency: 'SPM',
			area: 'APAC',
			chargeCode: '65012834',
			clientCountry: 'Philippines',
			...
			secondaryLocation: 'India (IN)',
			accountName: 'BDO Unibank',
			lifeCycle: 'Custom Implementation',
			workDescription: '',
		},
	},
	{
		...
		details: {
			...
			endDate: '31/03/2027',
			deliveryOwnedBy: 'CSS',
			projectManager: 'Gomez, Lida',
			primaryLocation: 'Japan-Tokyo',
			pmDelegate: 'Yamamoto, Kenji',
			competencyHead: 'Nakamura, Yuki',
			deliveryManager: 'Watanabe, Sho',
			subCompetency: 'Product Management',
			area: 'Japan',
			chargeCode: '91340025',
			clientCountry: 'Japan',
			methodology: 'Kanban',
